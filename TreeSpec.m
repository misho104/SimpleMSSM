...
NeutralinoDiagonalize[m_] := Module[{v, x},
...
CalculateSpectrum[slha_, OFile_] := Module[
    ...
    (* masses *)
    {diag, nmix} = NeutralinoDiagonalize[NeutralinoMass[sm, mssm]];
